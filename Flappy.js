...
function preload() {
  ...
  this.load.image(
    "menutext",
    "https://labs.phaser.io/assets/sprites/button-text.png"
  );
  ...
  this.load.audio(
    "playerded",
    "https://labs.phaser.io/assets/audio/SoundEffects/player_death.wav"
  );
  this.load.image(
    "Boom",
    "https://labs.phaser.io/assets/sprites/shmup-boom.png"
  );
  ...
  this.load.image(
    "green",
    "https://labs.phaser.io/assets/sprites/orb-green.png"
  );
  ...
  this.load.audio(
    "MissleBoom",
    "https://labs.phaser.io/assets/audio/SoundEffects/sentry_explode.wav"
  );
  this.load.audio(
    "Cooldown",
    "https://labs.phaser.io/assets/audio/SoundEffects/need_cells.wav"
  );
  this.load.audio(
    "reload",
    "https://labs.phaser.io/assets/audio/SoundEffects/battery.wav"
  );
}
function create() {
  ...
  Use1 = -1;
  scoreText = this.add
    .text(40, 46, "Score: 0", { fontSize: "32px", fill: "#0f0" })
    .setDepth(3);
  ammoText = this.add
    .text(40, 78, "Ammo: 2", { fontSize: "32px", fill: "#0f0" })
    .setDepth(3);
  var content = [
  ...
  instructionText1 = this.add
    .text(250, 200, content, { fontFamily: "Arial", color: "#00ff00" })
    .setOrigin(0)
    .setDepth(5);
